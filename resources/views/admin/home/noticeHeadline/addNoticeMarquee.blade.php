                ...
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('storeNoticeMarquee')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="submit" class="form-control btn btn-success" value="Create Headline" style="color: white"/>
                                    </div>
                                </div>
                            </form>
                        </div>
